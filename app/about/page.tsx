					...
					>
						...
						<div className='bg-deep-blue text-white p-8 rounded-2xl'>
							<p className='text-gray-200 leading-relaxed italic'>
								...
								between old-world value and modern participation. We saw a need
								for a platform that helps ordinary people reconnect with real
								assets while benefiting from the reach and power of modern
								communities.
							</p>
						</div>
					</motion.div>
